...
export const projectsData: Project[] = [
  {
    ...
    features: [
      ...
      'Organized voting workflow',
    ],
    contributions: [
      'Designed the student voting interface',
      'Developed the voting workflow',
      'Implemented user and administrator functionality',
      'Managed vote records',
      'Implemented result-management functionality',
      'Applied database concepts',
      'Focused on simple and practical usability',
    ],
    learnings: [
      'Building a complete web application workflow',
      'Handling user and administrator functionality',
      'Working with structured data',
      'Applying database concepts in a practical project',
      'Designing user-friendly interfaces',
      'Understanding the basic architecture of a voting system',
    ],
  },
  {
    title: 'Rentogo',
    ...
    features: [
      ...
      'Home and room listings',
      'Structured property information',
      'Property browsing',
      'Property detail pages',
      'Organized listing interface',
      'User-friendly navigation',
      'Practical rental discovery workflow',
    ],
    contributions: [
      'Designed the rental browsing interface',
      'Created structured property listings',
      'Created property detail presentation',
      'Organized rental information',
      'Focused on intuitive navigation',
      'Built the interface around a practical rental-discovery workflow',
    ],
    learnings: [
      'Designing listing-based web applications',
      'Organizing structured property data',
      'Creating user-friendly browsing experiences',
      'Building reusable UI components where applicable',
      'Understanding practical marketplace-style application design',
    ],
  },
  {
    title: 'Smart Store Management System',
    slug: 'smart-store-management',
    year: '2026',
    category: 'Database / Software Development',
    status: 'Completed',
    featured: false,
    ...
    features: [
      ...
      'Practical store-management workflow',
    ],
    contributions: [
      'Designed the store-management workflow',
      'Organized product information',
      'Managed inventory-related data',
      'Managed customer records',
      'Applied database concepts',
      'Implemented data storage and retrieval',
      'Focused on efficient information management',
    ],
    learnings: [
      ...
      'Applying DBMS concepts to a real-world problem',
      'Designing software around structured business information',
    ],
  },
  {
    title: 'AI Climate Twin India',
    subtitle: 'Climate Risk Prediction Platform',
    slug: 'ai-climate-twin-india',
    year: '2026',
    category: 'AI / Machine Learning / Full Stack / Climate Technology',
    status: 'Completed',
    featured: true,
    ...
    liveUrl: null,
    architecture: {
      summary: 'End-to-end full-stack climate intelligence system integrating geospatial meteorological datasets, TensorFlow ML models, an asynchronous FastAPI backend service, and interactive Mapbox React visualization.',
      components: [
        { name: 'Client UI & Mapbox', role: 'React SPA with interactive geospatial risk overlays' },
        { name: 'API Server', role: 'FastAPI Python asynchronous service for telemetry & inference' },
        { name: 'ML & Datasets Engine', role: 'TensorFlow models powered by IMD, NASA POWER, ERA5, & ISRO' },
      ],
    },
    features: [
      ...
      'ERA5 dataset pipeline',
      'ISRO dataset integration',
    ...
    contributions: [
      'Sourced climate and environmental datasets',
      'Worked with IMD, NASA POWER, ERA5, and ISRO datasets',
      'Built prediction workflows',
      'Implemented TensorFlow-based prediction models',
      'Developed the FastAPI backend',
      'Developed the React frontend',
      'Integrated Mapbox for interactive geospatial visualization',
      'Connected frontend, backend, and prediction components',
      'Worked across the workflow from data sourcing to deployment',
    ],
    learnings: [
      ...
      'TensorFlow modeling and inference',
      'FastAPI API development',
      'React frontend development',
      'Geospatial visualization',
      'Full-stack system integration',
      'Deploying an end-to-end technical solution',
    ],
  },
  {
    title: 'KrushiScan',
    slug: 'krushiscan',
    year: '2026',
    category: 'Web Development / Agriculture Technology',
    status: 'Completed',
    featured: false,
    ...
    features: [
      ...
      'Agriculture-focused digital platform',
      'Information organized for practical use',
    ],
    contributions: [
      'Designed the agriculture-focused interface',
      'Organized crop information',
      'Structured farming guidance',
      'Added market information',
      'Presented important alerts',
      'Focused on simple navigation',
      'Designed the system around practical agricultural information access',
    ],
    learnings: [
      'Designing domain-specific web applications',
      'Creating simple information architecture',
      'Building accessible user interfaces',
      'Organizing practical information',
      'Designing technology solutions around real-world user needs',
    ],
  },
  {
    title: 'Kabadiwala Connect',
    subtitle: 'SIH26229',
    slug: 'kabadiwala-connect',
    year: '2026',
    category: 'Full Stack / Social Impact / Recycling Technology / Smart India Hackathon',
    ...
    liveUrl: null,
    features: [
      'Household-to-collector connection',
      'Waste pickup marketplace',
      'Collector discovery',
      'Authorized recycler connection',
      'Transparent pricing',
      'Digital payment support',
      'Collector identity',
      'Recycling traceability',
      'Formal–informal recycling chain integration',
      'Structured pickup workflow',
      'Social-impact technology solution',
    ],
    contributions: [
      'Worked on the recycling-chain platform concept',
      'Designed the household/collector/recycler workflow',
      'Structured the pickup marketplace',
      'Worked on transparent pricing functionality',
      'Included collector identity concepts',
      'Included traceability concepts',
      'Worked on the digital solution architecture',
      'Prepared a 6-slide solution pitch deck',
      'Prepared the project for Smart India Hackathon 2026 Software Edition evaluation',
    ],
    learnings: [
      'Designing technology solutions for social-impact problems',
      'Marketplace workflow design',
      'Understanding multi-user platform architecture',
      'Product thinking',
      'Problem-to-solution mapping',
      'Hackathon solution development',
      'Presenting a technical solution through a concise pitch',
    ],
  },
];
